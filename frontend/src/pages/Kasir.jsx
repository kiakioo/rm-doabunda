...
const Kasir = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-50 font-sans">
      ...
      <div className="w-full md:w-2/3 md:h-full flex flex-col relative z-0">
        ...
        <div className="bg-white p-4 md:p-6 border-b border-gray-200 flex flex-col sm:flex-row justify-between sm:items-center gap-4 shadow-sm z-10 shrink-0">
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              <h1 className="text-xl md:text-2xl font-black text-doabunda-dark tracking-wide">
                MESIN KASIR
              </h1>
      ...
      {/* KANAN: Panel Pesanan */}
      <div className="w-full md:w-1/3 md:h-full bg-white shadow-[0_-10px_30px_rgba(0,0,0,0.05)] md:shadow-[-10px_0_30px_rgba(0,0,0,0.03)] flex flex-col z-20 md:border-l border-gray-200">
        ...
        <div className="p-4 md:p-6 border-b border-gray-100 flex justify-between items-center shrink-0">
          <div className="flex items-center gap-2 md:gap-3 text-doabunda-dark">
            ...
            <span className="bg-doabunda-primary text-white text-xs px-2 py-0.5 rounded-full">
              {cart.length}
            </span>
          </div>
          <button 
        ...
        <div className="p-4 md:p-6 bg-gray-50 border-t border-gray-200 shrink-0">
          ...
          <div className="grid grid-cols-3 gap-2 md:gap-3">
            <button 
              ...
              className="flex flex-col items-center justify-center bg-white border-2 border-green-600 text-green-700 py-2 md:py-4 rounded-xl hover:bg-green-600 hover:text-white transition-all active:scale-95 font-bold shadow-sm group"
            >
              <Wallet size={18} className="md:w-6 md:h-6 mb-1 md:mb-2" />
              <span className="text-[10px] md:text-xs tracking-wider">CASH</span>
            </button>

            <button 
              onClick={() => handleCheckout('QRIS')} 
              className="flex flex-col items-center justify-center bg-white border-2 border-blue-600 text-blue-700 py-2 md:py-4 rounded-xl hover:bg-blue-600 hover:text-white transition-all active:scale-95 font-bold shadow-sm group"
            >
              <CreditCard size={18} className="md:w-6 md:h-6 mb-1 md:mb-2" />
              <span className="text-[10px] md:text-xs tracking-wider">QRIS</span>
            </button>

            <button 
              onClick={() => handleCheckout('Grab')} 
              className="flex flex-col items-center justify-center bg-doabunda-dark text-white py-2 md:py-4 rounded-xl hover:bg-doabunda-primary transition-all active:scale-95 font-bold shadow-sm border-2 border-doabunda-dark group"
            >
              <Truck size={18} className="md:w-6 md:h-6 mb-1 md:mb-2" />
