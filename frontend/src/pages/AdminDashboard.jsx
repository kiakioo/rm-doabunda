...
const AdminDashboard = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-doabunda-light font-sans">
      ...
      {/* SIDEBAR */}
      <div className="w-full md:w-72 bg-doabunda-dark text-white p-6 flex flex-col justify-between shadow-2xl">
        ...
        <div>
          ...
          <nav className="space-y-2">
            ...
            <button 
              ...
              className="flex items-center gap-4 w-full p-4 text-white/70 hover:bg-white/5 rounded-xl"
            >
        ...
        <button 
          ...
          className="flex items-center gap-4 text-white/50 hover:text-white p-4"
        >
          <LogOut size={22} />
      ...
      <div className="flex-1 p-4 md:p-10 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          ...
          <div className="bg-gradient-to-br from-doabunda-gold to-[#d4b97a] p-6 md:p-8 rounded-2xl shadow-sm">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-doabunda-dark">
              {stats.totalTransactions} 
              <span className="text-xl md:text-2xl font-medium opacity-80"> Nota</span>
            </h2>
          </div>
